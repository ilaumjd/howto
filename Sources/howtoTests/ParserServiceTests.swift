...
class ParserServiceTests: XCTestCase {
    ...
    func testParseStackOverflowAnswer() throws {
        ...
        let answer = try parserService.parseStackOverflowAnswer(url: "https://example.com", htmlString: htmlString)
    ...
    func testParseStackOverflowAnswerNoAnswer() throws {
        ...
        XCTAssertThrowsError(try parserService.parseStackOverflowAnswer(url: "https://example.com", htmlString: htmlString)) { error in
